...
export const programs: ProgramTranslations = {
  ...
  'kohls-community-discounts': {
    name: "Kohl's Senior & Military Discounts",
    description:
      "Kohl's offers 15% off in-store purchases for seniors (60+) every Wednesday and for military/veterans every Monday with valid verification.",
    what_they_offer:
      "- 15% off in-store purchases for seniors every Wednesday\n- 15% off in-store purchases for military every Monday\n- Applies to most merchandise\n- Stackable with Kohl's Cash and coupons\n- No minimum purchase required",
    how_to_get_it:
      "1. Seniors: Visit any Kohl's store on Wednesday, ages 60+ eligible\n2. Military: Visit any Kohl's store on Monday with valid military ID\n3. Inform cashier you qualify for discount\n4. Discount applied at checkout\n5. Military includes active duty, veterans, retirees, and families",
    timeframe: 'Wednesdays (seniors), Mondays (military)',
    link_text: 'Find a Store',
  },
  'ross-senior-discount': {
    name: 'Ross Dress for Less Senior Discount',
    description:
      'Ross Dress for Less offers customers aged 55 and older a 10% discount on in-store purchases every Tuesday. Ask the cashier at checkout.',
    what_they_offer:
      '- 10% off entire in-store purchase\n- Available every Tuesday\n- Applies to all merchandise\n- Must request discount at checkout\n- Ages 55 and older eligible',
    how_to_get_it:
      '1. Visit any Ross store on Tuesday\n2. Inform cashier at checkout that you qualify\n3. 10% discount applied to purchase\n4. Ages 55 and older eligible\n5. Some location variations may apply',
    timeframe: 'Every Tuesday',
    link_text: 'Find a Store',
  },
  'dennys-senior-menu': {
    name: "Denny's 55+ Menu",
    description:
      "Denny's offers a dedicated 55+ menu with smaller portions at reduced prices. Available at all locations for guests aged 55 and older.",
    what_they_offer:
      '- Dedicated 55+ menu with value pricing\n- Smaller portion sizes\n- Popular breakfast and entrée options\n- Available all day\n- 15% off on designated senior discount days at some locations',
    how_to_get_it:
      "1. Visit any Denny's location\n2. Request the 55+ menu\n3. Ages 55 and older eligible\n4. Order from special menu\n5. Enjoy reduced pricing on select items",
    timeframe: 'Ongoing',
    link_text: 'View Menu',
  },
  'ihop-senior-menu': {
    name: 'IHOP 55+ Menu',
    description:
      'IHOP offers a 55+ menu featuring smaller portions of popular items at reduced prices. Available at participating locations for guests aged 55 and older.',
    what_they_offer:
      '- 55+ menu with reduced pricing\n- Smaller portion sizes\n- Breakfast favorites included\n- Available all day at most locations\n- No coupon or membership required',
    how_to_get_it:
      '1. Visit participating IHOP location\n2. Request the 55+ menu\n3. Ages 55 and older eligible\n4. Order from special menu\n5. Availability may vary by location',
    timeframe: 'Ongoing',
    link_text: 'Find a Location',
  },
  'walgreens-senior-day': {
    name: 'Walgreens Seniors Day',
    description:
      'Walgreens offers seniors aged 55+ a 20% discount on regularly priced items the first Tuesday of each month. Must be a myWalgreens member (free to join).',
    what_they_offer:
      '- 20% off regularly priced items\n- Available first Tuesday of each month\n- Excludes prescriptions, alcohol, tobacco, dairy, and select items\n- Must be myWalgreens member (free)\n- Ages 55 and older eligible',
    how_to_get_it:
      '1. Join myWalgreens rewards program (free)\n2. Visit Walgreens on first Tuesday of month\n3. Show myWalgreens membership at checkout\n4. Discount applied in-store and online\n5. Ages 55 and older eligible',
    timeframe: 'First Tuesday monthly',
    link_text: 'Find a Store',
  },
  'rite-aid-senior-day': {
    name: 'Rite Aid Senior Day',
    description:
      'Rite Aid offers seniors aged 65+ 5x rewards points on qualifying purchases the first Wednesday of each month with their free Rite Aid Rewards card.',
    what_they_offer:
      '- 5x rewards points on qualifying purchases\n- First Wednesday of each month\n- Free Rite Aid Rewards card required\n- Points redeemable for discounts on future purchases\n- Ages 65 and older eligible',
    how_to_get_it:
      '1. Sign up for free Rite Aid Rewards card\n2. Visit Rite Aid on first Wednesday of month\n3. Present rewards card at checkout\n4. Earn 5x points on qualifying purchases\n5. Ages 65 and older eligible',
    timeframe: 'First Wednesday monthly',
    link_text: 'Find a Store',
  },
  'amazon-prime': {
    name: 'Amazon Prime',
  ...
  'adidas-first-responder': {
    name: 'Adidas First Responder Discount',
    description:
      'Adidas offers a 30% discount to first responders on full-price items and 20% off at outlet stores. Verification through ID.me required.',
    what_they_offer:
      '- 30% off full-price items on adidas.com\n- 20% off at Adidas outlet stores\n- Applies to shoes, clothing, and accessories\n- Can be combined with some promotions\n- Available to verified first responders',
    how_to_get_it:
      '1. Visit adidas.com\n2. Sign in and verify status through ID.me\n3. Eligible: firefighters, EMTs, police, paramedics\n4. Discount applied at checkout automatically\n5. Valid on adidas.com and outlet stores',
    timeframe: 'Ongoing',
    link_text: 'Verify & Save',
  },
  '511-tactical-first-responder': {
    name: '5.11 Tactical First Responder Discount',
    description:
      '5.11 Tactical offers first responders and military personnel 25% off select gear and apparel through GovX verification.',
    what_they_offer:
      '- 25% off select tactical gear and apparel\n- Includes bags, boots, clothing, and accessories\n- Available through GovX membership\n- Professional-grade equipment\n- Exclusive access to special offers',
    how_to_get_it:
      '1. Create free GovX account at govx.com\n2. Verify first responder or military status\n3. Access 5.11 Tactical discount through GovX\n4. Eligible: law enforcement, fire, EMS, military\n5. Shop discounted items through verified account',
    timeframe: 'Ongoing',
    link_text: 'Shop Now',
  },
  'samsung-first-responder': {
    name: 'Samsung First Responder Discount',
    description:
      'Samsung offers first responders up to 30% off on phones, tablets, TVs, and appliances through their Education Offers Program with ID.me verification.',
    what_they_offer:
      '- Up to 30% off Samsung phones and tablets\n- Discounts on TVs and home appliances\n- Combinable with most promotional offers\n- Applies to Galaxy smartphones, tablets, watches\n- Available to verified first responders',
    how_to_get_it:
      '1. Visit samsung.com/us/shop/discount-program\n2. Select First Responder Program\n3. Verify status through ID.me\n4. Eligible: police, firefighters, EMTs, paramedics\n5. Discount shown on eligible products',
    timeframe: 'Ongoing',
    link_text: 'Verify & Shop',
  },
  'carhartt-first-responder': {
    name: 'Carhartt First Responder Discount',
    description:
      'Carhartt offers first responders a 15% discount on workwear and apparel with ID.me verification at checkout.',
    what_they_offer:
      '- 15% off all Carhartt products\n- Applies to workwear, jackets, pants, accessories\n- Online purchases at carhartt.com\n- Combinable with some promotions\n- Year-round discount',
    how_to_get_it:
      '1. Visit carhartt.com\n2. Add items to cart\n3. At checkout, verify through ID.me\n4. Eligible: firefighters, EMTs, police, paramedics\n5. 15% discount applied automatically',
    timeframe: 'Ongoing',
    link_text: 'Shop & Verify',
  },
  'lululemon-first-responder': {
    name: 'lululemon First Responder Discount',
    description:
      'lululemon offers first responders and healthcare workers a 15% discount on online and in-store purchases with verification.',
    what_they_offer:
      '- 15% off online and in-store purchases\n- Applies to athletic wear, yoga gear, accessories\n- Available on full-price and sale items\n- Valid for police, fire, EMS, nurses\n- Year-round discount',
    how_to_get_it:
      '1. Online: Visit lululemon.com and verify at checkout\n2. In-store: Show valid work ID or badge\n3. Eligible: law enforcement, firefighters, EMTs, nurses\n4. Healthcare workers also qualify\n5. Discount applied at point of sale',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'tuft-needle-first-responder': {
    name: 'Tuft & Needle First Responder Discount',
    description:
      'Tuft & Needle offers first responders 15% off mattresses, bedding, and sleep accessories year-round.',
    what_they_offer:
      '- 15% off mattresses\n- 15% off bedding and accessories\n- Applies to all Tuft & Needle products\n- Free shipping on mattresses\n- 100-night sleep trial included',
    how_to_get_it:
      '1. Visit tuftandneedle.com\n2. Browse products and add to cart\n3. Verify first responder status at checkout\n4. Eligible: law enforcement, firefighters, EMTs, paramedics\n5. 15% discount applied automatically',
    timeframe: 'Ongoing',
    link_text: 'Shop Now',
  },
  'michaels-teacher-discount': {
    ...
    description:
      'Michaels offers teachers and educators 15% off every purchase in-store and online when enrolled in the free Michaels Rewards program.',
    what_they_offer:
      '- 15% off every in-store and online purchase\n- Applies to craft supplies, art materials, décor\n- Free Michaels Rewards membership\n- Stackable with coupons and sales\n- No minimum purchase required',
    how_to_get_it:
      '1. Join free Michaels Rewards at michaels.com\n2. Register as an educator in rewards profile\n3. In-store: Show school ID at checkout\n4. Online: Discount applied automatically when signed in\n5. K-12 teachers and administrators eligible',
    timeframe: 'Ongoing',
    link_text: 'Join Rewards',
  },
  'staples-teacher-discount': {
    name: 'Staples Teacher Rewards',
    description:
      'Staples offers teachers 20% off in-store purchases with app coupon and teacher ID, plus special back-to-school savings and rewards.',
    what_they_offer:
      '- 20% off in-store with app coupon and teacher ID\n- Special teacher appreciation events\n- Back-to-school supply deals\n- Staples Rewards points on purchases\n- Free shipping on orders $30+',
    how_to_get_it:
      '1. Download Staples app\n2. Find teacher discount coupon in app\n3. Present coupon and teacher ID at checkout\n4. K-12 teachers and administrators eligible\n5. Check app for current offers',
    timeframe: 'Ongoing',
    link_text: 'Download App',
  },
  'office-depot-teacher-discount': {
    name: 'Office Depot/OfficeMax Teacher Discount',
    description:
      'Office Depot/OfficeMax offers teachers 25% cash back on qualifying in-store purchases with teacher ID through their rewards program.',
    what_they_offer:
      '- 25% cash back on qualifying in-store purchases\n- Free rewards membership required\n- Back-to-school teacher appreciation events\n- Up to 5% back through Office Depot Rewards\n- Special educator pricing on select items',
    how_to_get_it:
      '1. Join free Office Depot Rewards program\n2. Register as educator in rewards profile\n3. Show teacher ID at checkout\n4. Cash back applied to rewards account\n5. K-12 teachers and administrators eligible',
    timeframe: 'Ongoing',
    link_text: 'Join Rewards',
  },
  'joann-teacher-discount': {
    name: 'JOANN Teacher Discount',
    description:
      'JOANN offers teachers 15% off total purchase every day with valid teacher ID in-store or through online verification.',
    what_they_offer:
      '- 15% off total purchase\n- Applies to fabric, craft supplies, art materials\n- Available in-store and online\n- Stackable with some coupons\n- Year-round discount',
    how_to_get_it:
      '1. In-store: Show valid teacher ID at checkout\n2. Online: Verify teacher status through ID.me\n3. K-12 teachers, homeschool parents eligible\n4. Childcare workers and professors also qualify\n5. Discount applied at checkout',
    timeframe: 'Ongoing',
    link_text: 'Find a Store',
  },
  ...
  'enterprise-adaptive-equipment': {
    name: 'Enterprise Adaptive Driving Equipment',
    description:
      'Enterprise Rent-A-Car provides adaptive driving equipment at no additional charge to customers with disabilities, including hand controls, spinner knobs, left foot accelerators, and pedal extenders.',
    what_they_offer:
      '- Hand controls at no extra charge\n- Left foot accelerators\n- Spinner knobs\n- Pedal extenders\n- No additional rental fee for equipment\n- Available at most US locations',
    how_to_get_it:
      '1. Call Enterprise reservation line: 1-866-225-4284\n2. Request adaptive equipment when booking\n3. Specify type of equipment needed\n4. Allow 24-72 hours advance notice\n5. Equipment installed before pickup\n6. No additional documentation required',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'hertz-accessibility-services': {
    name: 'Hertz Accessibility Services',
    description:
      'Hertz offers hand controls, spinner knobs, and accessible parking services to customers with disabilities at no additional charge.',
    what_they_offer:
      '- Hand controls at no extra charge\n- Spinner knobs\n- Accessible parking services\n- Portable hand controls available\n- Some restrictions on vehicle types\n- Available at participating locations',
    how_to_get_it:
      '1. Call Hertz: 1-800-654-3131\n2. Request adaptive equipment when booking\n3. Provide at least 24-48 hours notice\n4. Confirm equipment availability at pickup location\n5. Equipment provided at no additional cost',
    timeframe: 'Ongoing',
    link_text: 'Make a Reservation',
  },
  'ford-mobility-rebate': {
    name: 'Ford Mobility Motoring Program',
    description:
      'Ford offers up to $1,000 reimbursement toward the cost of adaptive equipment or $200 for alert hearing devices, lumbar support, or running boards when purchasing or leasing a new Ford vehicle.',
    what_they_offer:
      '- Up to $1,000 reimbursement for adaptive equipment\n- $200 rebate for alert hearing devices\n- $200 rebate for lumbar support\n- $200 rebate for running boards\n- Available on new Ford vehicle purchase or lease\n- Applies to eligible equipment installations',
    how_to_get_it:
      '1. Purchase or lease new Ford vehicle\n2. Have eligible adaptive equipment installed\n3. Submit reimbursement request with receipts\n4. Mail to Ford Mobility Motoring Program\n5. Receive reimbursement check\n6. Must submit within 12 months of purchase',
    timeframe: 'Within 12 months of vehicle purchase',
    link_text: 'Learn More',
  },
  'gm-mobility-program': {
    name: 'GM Mobility Reimbursement Program',
    description:
      'General Motors offers up to $1,500 reimbursement for adaptive equipment installation on new Chevrolet, Buick, Cadillac, or GMC vehicles.',
    what_they_offer:
      '- Up to $1,500 reimbursement for adaptive equipment\n- Applies to Chevrolet, Buick, Cadillac, GMC vehicles\n- Covers hand controls, wheelchair lifts, and more\n- Available on new vehicle purchase or lease\n- No pre-approval required',
    how_to_get_it:
      '1. Purchase or lease new eligible GM vehicle\n2. Have adaptive equipment installed by qualified installer\n3. Complete reimbursement application\n4. Submit receipts and documentation\n5. Mail to GM Mobility Program\n6. Receive reimbursement check (6-8 weeks)',
    timeframe: 'Within 12 months of vehicle purchase',
    link_text: 'Learn More',
  },
  'challenged-athletes-grants': {
    name: 'Challenged Athletes Foundation Grants',
    description:
      'The Challenged Athletes Foundation provides grants for adaptive sports equipment, training, and competition expenses to individuals with physical disabilities.',
    what_they_offer:
      '- Grants for adaptive sports equipment\n- Funding for athletic prosthetics\n- Support for competition travel expenses\n- Training and coaching expense grants\n- Adaptive sport wheelchairs\n- Handcycles, sit-skis, and more',
    how_to_get_it:
      '1. Visit challengedathletes.org\n2. Review grant categories and eligibility\n3. Complete online grant application\n4. Submit supporting documentation\n5. Applications reviewed quarterly\n6. Must have permanent physical disability',
    timeframe: 'Quarterly application deadlines',
    link_text: 'Apply for Grant',
  },
  'll-bean-military': {
    name: 'L.L. Bean Military & First Responder Discount',
    description:
      'L.L. Bean offers a 10% discount to military personnel, veterans, and first responders on most purchases through SheerID verification.',
    what_they_offer:
      '- 10% off most purchases\n- Applies to outdoor gear, clothing, footwear\n- Valid on llbean.com\n- Excludes some items (kayaks, canoes, gift cards)\n- Year-round discount',
    how_to_get_it:
      '1. Visit llbean.com\n2. Add items to cart\n3. At checkout, verify through SheerID\n4. Eligible: active military, veterans, retirees, first responders\n5. 10% discount applied automatically',
    timeframe: 'Ongoing',
    link_text: 'Learn More',
  },
  'gamespot-military': {
    name: 'GameStop Military Discount',
    description:
      'GameStop offers active and former military personnel 10% off new and pre-owned video games, hardware, accessories, and collectibles year-round.',
    what_they_offer:
      '- 10% off video games (new and pre-owned)\n- 10% off gaming hardware and accessories\n- 10% off collectibles\n- Available in-store with valid ID\n- Year-round discount',
    how_to_get_it:
      '1. Visit any GameStop store\n2. Present valid military ID at checkout\n3. Active duty, veterans, retirees, and dependents eligible\n4. Discount applied to eligible purchases\n5. Some exclusions may apply',
    timeframe: 'Ongoing',
    link_text: 'Find a Store',
  },
